...
// Generated at /home/vrjuliao/workfolder/lac-dcc/honey-potion/lib/honey/translator.ex:252
Generic helper_var_6 = ATOM_TRUE;
Generic helper_var_38;
op_result.exception = 0;
if(helper_var_6.type != ATOM || helper_var_6.value.string.start != 3 ) {
...
if(op_result.exception == 0) {
  Generic helper_var_102 = ATOM_FALSE;
  helper_var_38 = helper_var_102;
} else {
  op_result.exception = 0;
if(helper_var_6.type != ATOM || helper_var_6.value.string.start != 8 ) {
  op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
  goto label_134;
}
...
label_134:
if(op_result.exception == 0) {
  Generic helper_var_166 = ATOM_TRUE;
  helper_var_38 = helper_var_166;
} else {
...
Generic helper_var_198;
op_result.exception = 0;
if(helper_var_38.type != ATOM || helper_var_38.value.string.start != 3 ) {
  op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
  goto label_230;
}
...
label_230:
if(op_result.exception == 0) {
  Generic helper_var_262 = ATOM_FALSE;
  helper_var_198 = helper_var_262;
} else {
  op_result.exception = 0;
if(helper_var_38.type != ATOM || helper_var_38.value.string.start != 8 ) {
  op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
  goto label_294;
}
...
label_294:
if(op_result.exception == 0) {
  Generic helper_var_326 = ATOM_TRUE;
  helper_var_198 = helper_var_326;
} else {
    op_result = (OpResult){.exception = 1, .exception_msg = "(CaseClauseError) no case clause matching."};
  goto CATCH;
