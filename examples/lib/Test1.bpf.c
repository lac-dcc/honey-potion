...
Generic helper_var_866 = {.type = INTEGER, .value.integer = 0};
// Generated at /mnt/1tera/Kael media/kPrograms/GitHub/honey-potion/lib/honey/translator.ex:347
Generic helper_var_898 = ATOM_TRUE;
if (to_bool(&helper_var_898)) {
  Generic helper_var_930 = {.type = INTEGER, .value.integer = 4};
  helper_var_866 = helper_var_930;
} else {
  helper_var_866 = (Generic){.type = ATOM, .value.string = (String){0, 2}};
}


Generic helper_var_962 = {.type = INTEGER, .value.integer = 2};

  // =============== end of user code ==============
  // Generated at /mnt/1tera/Kael media/kPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:391
if (helper_var_962.type != INTEGER) {
  op_result = (OpResult){.exception = 1, .exception_msg = "(IncorrectReturn) eBPF function is not returning an integer."};
  goto CATCH;
}
return helper_var_962.value.integer;
