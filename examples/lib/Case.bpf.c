...
// Generated at /home/vrjuliao/workfolder/lac-dcc/honey-potion/lib/honey/translator.ex:299
Generic helper_var_40 = {.type = INTEGER, .value.integer = 1};
op_result.exception = 0;
Generic x0 = helper_var_40;
...
// Generated at /home/vrjuliao/workfolder/lac-dcc/honey-potion/lib/honey/translator.ex:299
// Generated at /home/vrjuliao/workfolder/lac-dcc/honey-potion/lib/honey/translator.ex:252

Generic helper_var_104;
op_result.exception = 0;
if(x0.type != STRING) {
...
String helper_var_200 = x0.value.string;
if(3 != (helper_var_200.end - helper_var_200.start)){
  op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
  goto label_136;
}
if(helper_var_200.start < STRING_POOL_SIZE - 0 && helper_var_200.start >= 0) {
  if('s' != *((*string_pool)+(helper_var_200.start + 0))) {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
    goto label_136;
  }
}
if(helper_var_200.start < STRING_POOL_SIZE - 1 && helper_var_200.start >= 0) {
  if('t' != *((*string_pool)+(helper_var_200.start + 1))) {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
    goto label_136;
  }
}
if(helper_var_200.start < STRING_POOL_SIZE - 2 && helper_var_200.start >= 0) {
  if('r' != *((*string_pool)+(helper_var_200.start + 2))) {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
    goto label_136;
  }
}
...
if(op_result.exception == 0) {
  Generic helper_var_168 = {.type = INTEGER, .value.integer = 0};
  helper_var_104 = helper_var_168;
} else {
  op_result.exception = 0;
if(x0.type != ATOM || x0.value.string.start != 0 ) {
  op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
  goto label_232;
}
...
label_232:
if(op_result.exception == 0) {
  Generic helper_var_264 = {.type = INTEGER, .value.integer = 0};
  helper_var_104 = helper_var_264;
} else {
  op_result.exception = 0;
if(x0.type != ATOM || x0.value.string.start != 3 ) {
  op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
  goto label_296;
}
...
label_296:
if(op_result.exception == 0) {
  Generic helper_var_328 = {.type = INTEGER, .value.integer = 0};
  helper_var_104 = helper_var_328;
} else {
  op_result.exception = 0;
if(x0.type != ATOM || x0.value.string.start != 8 ) {
  op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
  goto label_360;
}
...
label_360:
if(op_result.exception == 0) {
  Generic helper_var_392 = {.type = INTEGER, .value.integer = 1};
  helper_var_104 = helper_var_392;
} else {
  op_result.exception = 0;

label_424:
if(op_result.exception == 0) {
  // Generated at /home/vrjuliao/workfolder/lac-dcc/honey-potion/lib/honey/translator.ex:83

Generic helper_var_456 = {.type = INTEGER, .value.integer = 1};
BINARY_OPERATION(helper_var_488, Sum, x0, helper_var_456)

  helper_var_104 = helper_var_488;
} else {
...
op_result.exception = 0;
Generic return1 = helper_var_104;
