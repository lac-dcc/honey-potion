...
int main_func(struct syscalls_enter_kill_args *ctx_arg)
{
  ...
  *tuple_pool_index = 0;
  ...
  // Generated at /home/vrjuliao/workfolder/lac-dcc/honey-potion/lib/honey/translator.ex:320
  Generic helper_var_4418 = {.type = INTEGER, .value.integer = 2};
  op_result.exception = 0;
  Generic y0 = helper_var_4418;
...
label_4386:
  ...
  Generic helper_var_3366 = {.type = INTEGER, .value.integer = 1};
  // Generated at /home/vrjuliao/workfolder/lac-dcc/honey-potion/lib/honey/translator.ex:273

  // Generated at /home/vrjuliao/workfolder/lac-dcc/honey-potion/lib/honey/translator.ex:273
  // Generated at /home/vrjuliao/workfolder/lac-dcc/honey-potion/lib/honey/translator.ex:502
  unsigned len_helper_var_3430 = 12;
  unsigned end_helper_var_3430 = *string_pool_index + len_helper_var_3430 - 1;
  if (end_helper_var_3430 + 1 >= STRING_POOL_SIZE)
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MemoryLimitReached) Impossible to create string, the string pool is full."};
    goto CATCH;
  }

  if (*string_pool_index < STRING_POOL_SIZE - len_helper_var_3430)
  {
    __builtin_memcpy(&(*string_pool)[*string_pool_index], "some string", len_helper_var_3430);
  }

  Generic helper_var_3398 = {.type = STRING, .value.string = (String){.start = *string_pool_index, .end = end_helper_var_3430}};
  *string_pool_index = end_helper_var_3430 + 1;

  Generic helper_var_3462 = {.type = INTEGER, .value.integer = 4};
  if (*heap_index < (HEAP_SIZE - 0))
  {
    (*heap)[(*heap_index) + 0] = helper_var_3398;
  }
  else
  {
  ...
  {
    (*heap)[(*heap_index) + 1] = helper_var_3462;
  }
  else
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MemoryLimitReached) Impossible to allocate memory in the heap."};
  ...
  *tuple_pool_index += 2;
  ...
  Generic helper_var_3494 = {.type = TUPLE, .value.tuple = (Tuple){.start = (*tuple_pool_index) - 2, .end = (*tuple_pool_index) - 1}};

  if (*heap_index < (HEAP_SIZE - 0))
  {
    (*heap)[(*heap_index) + 0] = y0;
  }
  else
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MemoryLimitReached) Impossible to allocate memory in the heap."};
  ...
  if (*heap_index < (HEAP_SIZE - 1))
  {
    (*heap)[(*heap_index) + 1] = helper_var_3494;
  }
  else
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MemoryLimitReached) Impossible to allocate memory in the heap."};
  ...
  *tuple_pool_index += 2;
  ...
  Generic helper_var_3526 = {.type = TUPLE, .value.tuple = (Tuple){.start = (*tuple_pool_index) - 2, .end = (*tuple_pool_index) - 1}};

  if (*heap_index < (HEAP_SIZE - 0))
  {
    (*heap)[(*heap_index) + 0] = helper_var_3366;
  }
  else
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MemoryLimitReached) Impossible to allocate memory in the heap."};
  ...
  if (*heap_index < (HEAP_SIZE - 1))
  {
    (*heap)[(*heap_index) + 1] = helper_var_3526;
  }
  else
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MemoryLimitReached) Impossible to allocate memory in the heap."};
  ...
  *tuple_pool_index += 2;
  ...
  Generic helper_var_3558 = {.type = TUPLE, .value.tuple = (Tuple){.start = (*tuple_pool_index) - 2, .end = (*tuple_pool_index) - 1}};

  op_result.exception = 0;
  if (helper_var_3558.type != TUPLE)
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
    goto label_3334;
  }
  Generic helper_var_3590;
  if (helper_var_3558.value.tuple.start + 0 < TUPLE_POOL_SIZE && helper_var_3558.value.tuple.start + 0 >= 0)
  {
    unsigned helper_var_3622 = *((*tuple_pool) + (helper_var_3558.value.tuple.start + 0));
    if (helper_var_3622 < HEAP_SIZE && helper_var_3622 >= 0)
    {
      helper_var_3590 = *(*(heap) + (helper_var_3622));
    }
    else
    {
  ...
  if (helper_var_3590.type != INTEGER || 1 != helper_var_3590.value.integer)
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
    goto label_3334;
  }
  Generic helper_var_3654;
  if (helper_var_3558.value.tuple.start + 1 < TUPLE_POOL_SIZE && helper_var_3558.value.tuple.start + 1 >= 0)
  {
    unsigned helper_var_3686 = *((*tuple_pool) + (helper_var_3558.value.tuple.start + 1));
    if (helper_var_3686 < HEAP_SIZE && helper_var_3686 >= 0)
    {
      helper_var_3654 = *(*(heap) + (helper_var_3686));
    }
    else
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "HEAP(MatchError) No match of right hand side value."};
  ...
  if (helper_var_3654.type != TUPLE)
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
    goto label_3334;
  }
  Generic helper_var_3718;
  if (helper_var_3654.value.tuple.start + 0 < TUPLE_POOL_SIZE && helper_var_3654.value.tuple.start + 0 >= 0)
  {
    unsigned helper_var_3750 = *((*tuple_pool) + (helper_var_3654.value.tuple.start + 0));
    if (helper_var_3750 < HEAP_SIZE && helper_var_3750 >= 0)
    {
      helper_var_3718 = *(*(heap) + (helper_var_3750));
    }
    else
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "HEAP(MatchError) No match of right hand side value."};
  ...
  if (helper_var_3718.type != INTEGER || 2 != helper_var_3718.value.integer)
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
    goto label_3334;
  }
  Generic helper_var_3782;
  if (helper_var_3654.value.tuple.start + 1 < TUPLE_POOL_SIZE && helper_var_3654.value.tuple.start + 1 >= 0)
  {
    unsigned helper_var_3814 = *((*tuple_pool) + (helper_var_3654.value.tuple.start + 1));
    if (helper_var_3814 < HEAP_SIZE && helper_var_3814 >= 0)
    {
      helper_var_3782 = *(*(heap) + (helper_var_3814));
    }
    else
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "HEAP(MatchError) No match of right hand side value."};
  ...
  if (helper_var_3782.type != TUPLE)
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
    goto label_3334;
  }
  Generic helper_var_3846;
  if (helper_var_3782.value.tuple.start + 0 < TUPLE_POOL_SIZE && helper_var_3782.value.tuple.start + 0 >= 0)
  {
    unsigned helper_var_3878 = *((*tuple_pool) + (helper_var_3782.value.tuple.start + 0));
    if (helper_var_3878 < HEAP_SIZE && helper_var_3878 >= 0)
    {
      helper_var_3846 = *(*(heap) + (helper_var_3878));
    }
    else
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "HEAP(MatchError) No match of right hand side value."};
  ...
  if (helper_var_3846.type != STRING)
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
    goto label_3334;
  }

  String helper_var_3910 = helper_var_3846.value.string;
  if (11 != (helper_var_3910.end - helper_var_3910.start))
  {
    op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
    goto label_3334;
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 0 && helper_var_3910.start >= 0)
  {
    if ('s' != *((*string_pool) + (helper_var_3910.start + 0)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 1 && helper_var_3910.start >= 0)
  {
    if ('o' != *((*string_pool) + (helper_var_3910.start + 1)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 2 && helper_var_3910.start >= 0)
  {
    if ('m' != *((*string_pool) + (helper_var_3910.start + 2)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 3 && helper_var_3910.start >= 0)
  {
    if ('e' != *((*string_pool) + (helper_var_3910.start + 3)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 4 && helper_var_3910.start >= 0)
  {
    if (' ' != *((*string_pool) + (helper_var_3910.start + 4)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 5 && helper_var_3910.start >= 0)
  {
    if ('s' != *((*string_pool) + (helper_var_3910.start + 5)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 6 && helper_var_3910.start >= 0)
  {
    if ('t' != *((*string_pool) + (helper_var_3910.start + 6)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 7 && helper_var_3910.start >= 0)
  {
    if ('r' != *((*string_pool) + (helper_var_3910.start + 7)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 8 && helper_var_3910.start >= 0)
  {
    if ('i' != *((*string_pool) + (helper_var_3910.start + 8)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 9 && helper_var_3910.start >= 0)
  {
    if ('n' != *((*string_pool) + (helper_var_3910.start + 9)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  if (helper_var_3910.start < STRING_POOL_SIZE - 10 && helper_var_3910.start >= 0)
  {
    if ('g' != *((*string_pool) + (helper_var_3910.start + 10)))
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "(MatchError) No match of right hand side value."};
      goto label_3334;
    }
  }
  Generic helper_var_3942;
  if (helper_var_3782.value.tuple.start + 1 < TUPLE_POOL_SIZE && helper_var_3782.value.tuple.start + 1 >= 0)
  {
    unsigned helper_var_3974 = *((*tuple_pool) + (helper_var_3782.value.tuple.start + 1));
    if (helper_var_3974 < HEAP_SIZE && helper_var_3974 >= 0)
    {
      helper_var_3942 = *(*(heap) + (helper_var_3974));
    }
    else
    {
      op_result = (OpResult){.exception = 1, .exception_msg = "HEAP(MatchError) No match of right hand side value."};
