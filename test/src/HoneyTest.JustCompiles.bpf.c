// Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:514
// Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:51
#include <linux/bpf.h>
#include <bpf/bpf_helpers.h>

// Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:70
#ifndef __inline
#define __inline \
...
// Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:112
...
// Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:204
// String pool
struct
{
...
// Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:453
...
static void Equals(OpResult *result, Generic *var1, Generic *var2) {
  ...
  *result = (OpResult){
  ...
  return;  
}// Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:283
...
// Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:294
...
// Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:480
SEC("tracepoint/syscalls/sys_enter_kill")
int main_func(struct syscalls_enter_kill_args *ctx_arg) {
  // Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:354
...
if (!heap_index)
{
  ...
  // Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:407
...
if (ctx0nil.value.syscalls_enter_kill_args.pos_sig < HEAP_SIZE)
{
  ...
  Generic helper_var_905 = {.type = INTEGER, .value.integer = 1};
  // =============== end of user code ==============
  // Generated at /run/media/kaelsa/1tera/Kael media/KPrograms/GitHub/honey-potion/lib/honey/boilerplates.ex:435
if (helper_var_905.type != INTEGER) {
  op_result = (OpResult){.exception = 1, .exception_msg = "(IncorrectReturn) eBPF function is not returning an integer."};
  goto CATCH;
}
return helper_var_905.value.integer;
